...
import { FirestoreError, _isBase64Available, Bytes, _logWarn, connectFirestoreEmulator, enableNetwork, disableNetwork, _validateIsNotUsedTogether, waitForPendingWrites, onSnapshotsInSync, collection, doc, collectionGroup, runTransaction, ensureFirestoreConfigured, WriteBatch as WriteBatch$1, executeWrite, loadBundle, namedQuery, AbstractUserDataWriter, DocumentReference as DocumentReference$1, refEqual, setDoc, updateDoc, deleteDoc, onSnapshot, getDocFromCache, getDocFromServer, getDoc, DocumentSnapshot as DocumentSnapshot$1, snapshotEqual, _debugAssert, addDoc, _DatabaseId, _cast, QueryDocumentSnapshot as QueryDocumentSnapshot$1, _DocumentKey, query, where, orderBy, limit, limitToLast, startAt, startAfter, endBefore, endAt, queryEqual, getDocsFromCache, getDocsFromServer, getDocs, QuerySnapshot as QuerySnapshot$1, enableIndexedDbPersistence, enableMultiTabIndexedDbPersistence, clearIndexedDbPersistence, setLogLevel as setLogLevel$1, FieldPath as FieldPath$1, _FieldPath, serverTimestamp, deleteField, arrayUnion, arrayRemove, increment, GeoPoint, Timestamp, CACHE_SIZE_UNLIMITED } from '@firebase/firestore';
...
var Transaction = /** @class */ (function () {
    ...
    Transaction.prototype.update = function (documentRef, dataOrField, value) {
        ...
        if (arguments.length === 2) {
            ...
            (_a = this._delegate).update.apply(_a, __spreadArray([ref, dataOrField, value], moreFieldsAndValues));
        }
        return this;
    };
    ...
    DocumentReference.prototype.update = function (fieldOrUpdateData, value) {
        ...
        try {
            if (arguments.length === 1) {
                ...
                return updateDoc.apply(void 0, __spreadArray([this._delegate, fieldOrUpdateData, value], moreFieldsAndValues));
            }
        }
        catch (e) {
...
var FieldPath = /** @class */ (function () {
    ...
    function FieldPath() {
        ...
        this._delegate = new (FieldPath$1.bind.apply(FieldPath$1, __spreadArray([void 0], fieldNames)))();
    }
