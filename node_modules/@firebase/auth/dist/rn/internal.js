...
function resetUnloadedGapiModules() {
    ...
    if (beacon === null || beacon === void 0 ? void 0 : beacon.H) {
        ...
        for (var _i = 0, _a = Object.keys(beacon.H); _i < _a.length; _i++) {
            ...
            beacon.H[hint].r = tslib.__spreadArray([], beacon.H[hint].L);
...
function _open(auth, url, name, width, height) {
    ...
    var target = '';
    var options = tslib.__assign(tslib.__assign({}, BASE_POPUP_OPTIONS), { width: width.toString(), height: height.toString(), top: top,
        left: left });
