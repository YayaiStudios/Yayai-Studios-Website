    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    tokenDetails = null;
                    return [4 /*yield*/, util.openDB(OLD_DB_NAME, OLD_DB_VERSION, function (db, oldVersion, newVersion, upgradeTransaction) { return tslib.__awaiter(_this, void 0, void 0, function () {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, util.deleteDB(OLD_DB_NAME)];
                case 4:
                    // Delete all old databases.
                    _a.sent();
                    return [4 /*yield*/, util.deleteDB('fcm_vapid_details_db')];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, util.deleteDB('undefined')];
                case 6:
                    _a.sent();
...
function getDbPromise() {
    if (!dbPromise) {
        dbPromise = util.openDB(DATABASE_NAME, DATABASE_VERSION, function (upgradeDb, oldVersion) {
