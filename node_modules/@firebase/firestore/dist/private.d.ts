 ...
 */
export declare function collection(firestore: Firestore_2, path: string, ...pathSegments: string[]): CollectionReference<DocumentData>;
 ...
 */
export declare function collectionGroup(firestore: Firestore_2, collectionId: string): Query<DocumentData>;
...
export declare class CollectionReference<T = DocumentData> extends Query<T> {
    ...
    /** @hideconstructor */
    constructor(firestore: Firestore_2, converter: FirestoreDataConverter_2<T> | null, _path: _ResourcePath);
 ...
 */
export declare function doc(firestore: Firestore_2, path: string, ...pathSegments: string[]): DocumentReference<DocumentData>;
...
export declare class DocumentReference<T = DocumentData> {
     ...
     * If provided, the `FirestoreDataConverter` associated with this instance.
     */
    converter: FirestoreDataConverter_2<T> | null, _key: _DocumentKey);
...
declare class DocumentSnapshot_2<T = DocumentData> {
    ...
    /** @hideconstructor protected */
    constructor(_firestore: Firestore_2, _userDataWriter: AbstractUserDataWriter, _key: _DocumentKey, _document: Document_2 | null, _converter: UntypedFirestoreDataConverter<T> | null);
...
declare interface PrivateSettings extends FirestoreSettings_2 {
...
export declare class QuerySnapshot<T = DocumentData> {
    ...
    /** @hideconstructor */
    constructor(_firestore: Firestore, _userDataWriter: AbstractUserDataWriter, query: Query<T>, _snapshot: ViewSnapshot);
